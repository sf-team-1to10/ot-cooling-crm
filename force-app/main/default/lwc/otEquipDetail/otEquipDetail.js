...
import GAL_01 from '@salesforce/resourceUrl/OT_CDU_Gallery_01';
import GAL_02 from '@salesforce/resourceUrl/OT_CDU_Gallery_02';
import GAL_03 from '@salesforce/resourceUrl/OT_CDU_Gallery_03';
import GAL_04 from '@salesforce/resourceUrl/OT_CDU_Gallery_04';
import GAL_05 from '@salesforce/resourceUrl/OT_CDU_Gallery_05';
...
export default class OtEquipDetail extends NavigationMixin(LightningElement) {
    ...
    get galleryImages() {
        return [
            { url: GAL_01, cap:'3/4 스튜디오 뷰', badge:'대표 이미지' },
            { url: GAL_02, cap:'정면 뷰', badge:'' },
            { url: GAL_03, cap:'도어 오픈 · 내부 배관', badge:'' },
            { url: GAL_04, cap:'후면 배관 인터페이스', badge:'' },
            { url: GAL_05, cap:'설치 현장', badge:'' }
        ];
    }
